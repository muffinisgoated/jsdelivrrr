(async function() {
    const folderPath = (path) => path.substring(0, path.length - path.split('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/').pop().length);
    let scriptPath = (typeof window.EJS_pathtodata === "string") ? window.EJS_pathtodata : folderPath((new URL(document.currentScript.src)).pathname);
    if (!scriptPath.endsWith('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/')) scriptPath+='https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/';
