class EJS_GameManager {
    constructor(Module, EJS) {
        ...
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch/userdata");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch/userdata/config");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch/userdata/config/Beetle PSX HW");
        this.FS.writeFile("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch/userdata/config/Beetle PSX HW/Beetle PSX HW.opt", 'beetle_psx_hw_renderer = "software"\n');
        
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/data");
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/data/saves");
        
        this.FS.writeFile("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user/retroarch/userdata/retroarch.cfg", this.getRetroArchCfg());
        
        this.FS.mount(IDBFS, {}, 'https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/data/saves');
        this.FS.syncfs(true, () => {});
    ...
    getRetroArchCfg() {
        return "autosave_interval = 60\n" +
               "screenshot_directory = \"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/\"\n" +
               ...
               "savefile_directory = \"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/data/saves\"\n";
    }
    initShaders() {
        if (!window.EJS_SHADERS) return;
        this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/shader");
        for (const shader in window.EJS_SHADERS) {
            this.FS.writeFile('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/shader/'+shader, window.EJS_SHADERS[shader]);
        }
    }
    restart() {
    ...
    loadState(state) {
        ...
        this.FS.writeFile('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/game.state', state);
    ...
    quickSave(slot) {
        ...
        (async () => {
            ...
            this.FS.writeFile('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/'+name, data);
        })();
    }
    quickLoad(slot) {
        if (!slot) slot = 1;
    ...
    createCueFile(fileNames) {
        ...
        let baseFileName = fileNames[0].split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/").pop();
        ...
        for (let i=0; i<fileNames.length; i++) {
            ...
            FS.writeFile("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+baseFileName+"-"+i+".cue", contents);
        }
        if (fileNames.length > 1) {
            let contents = "";
            for (let i=0; i<fileNames.length; i++) {
                contents += "https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+baseFileName+"-"+i+".cue\n";
            }
            FS.writeFile("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+baseFileName+".m3u", contents);
        }
        ...
        return new Promise(resolve => {
            this.EJS.downloadFile('cores/ppsspp-assets.zip', (res) => {
                this.EJS.checkCompression(new Uint8Array(res.data), this.EJS.localization("Decompress Game Data")).then((pspassets) => {
                    ...
                    this.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/PPSSPP");
                    
                    for (const file in pspassets) {
                        const data = pspassets[file];
                        const path = "https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/PPSSPP/"+file;
