...
if(ea)p=m?require("path").dirname(p)+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/":__dirname+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/",r=function(a,b){ia||(ia=require("fs"));ja||(ja=require("path"));a=ja.normalize(a);return ia.readFileSync(a,b?null:"utf8")},ha=function(a){a=r(a,!0);a.buffer||(a=new Uint8Array(a));assert(a.buffer);return a},1<process.argv.length&&(ca=process.argv[1].replace(/\\/g,"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/")),process.argv.slice(2),"undefined"!==typeof module&&(module.exports=c),process.on("uncaughtException",function(a){throw a;}),process.on("unhandledRejection",u),c.inspect=function(){return"[Emscripten Module object]"};
...
function O(a){var b="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===a.charAt(0),d="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===a.substr(-1);(a=Va(a.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/").filter(function(e){return!!e}),!b).join("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"))||b||(a=".");a&&d&&(a+="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");return(b?"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/":"")+a}function Wa(a){var b=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(a).slice(1);a=b[0];b=b[1];if(!a&&!b)return".";b&&(b=b.substr(0,b.length-1));return a+b}function P(a){if("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===a)return"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/";var b=a.lastIndexOf("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");return-1===b?a:a.substr(b+1)}
function Xa(){var a=Array.prototype.slice.call(arguments,0);return O(a.join("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"))}function Q(a,b){return O(a+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+b)}function Ya(a){return H[Za()>>2]=a}function R(){for(var a="",b=!1,d=arguments.length-1;-1<=d&&!b;d--){b=0<=d?arguments[d]:S.cwd();if("string"!==typeof b)throw new TypeError("Arguments to path.resolve must be strings");if(!b)return"";a=b+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+a;b="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===b.charAt(0)}a=Va(a.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/").filter(function(e){return!!e}),!b).join("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");return(b?"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/":"")+a||"."}
function $a(a,b){function d(k){for(var l=0;l<k.length&&""===k[l];l++);for(var q=k.length-1;0<=q&&""===k[q];q--);return l>q?[]:k.slice(l,q-l+1)}a=R(a).substr(1);b=R(b).substr(1);a=d(a.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"));b=d(b.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"));for(var e=Math.min(a.length,b.length),f=e,h=0;h<e;h++)if(a[h]!==b[h]){f=h;break}e=[];for(h=f;h<a.length;h++)e.push("..");e=e.concat(b.slice(f));return e.join("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/")}var ab=[];function bb(a,b){ab[a]={input:[],output:[],Ta:b};S.Hb(a,cb)}
...
f,f+e);f=!0;k=b.buffer==G.buffer;e=ua(e);if(!e)throw new S.ra(48);(k?G:b).set(a,e)}else f=!1,e=a.byteOffset;return{va:e,cd:f}},eb:function(a,b,d,e,f){if(!S.isFile(a.node.mode))throw new S.ra(43);if(f&2)return 0;T.ua.write(a,b,0,e,d,!1);return 0}}},U={ob:16895,Va:33279,Fb:null,Aa:function(a){function b(h){h=h.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");for(var k=e,l=0;l<h.length-1;l++){var q=h.slice(0,l+1).join("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");f[q]||(f[q]=U.createNode(k,h[l],U.ob,0));k=f[q]}return k}function d(h){h=h.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");return h[h.length-1]}assert(m);
U.Fb||(U.Fb=new FileReaderSync);var e=U.createNode(null,"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/",U.ob,0),f={};Array.prototype.forEach.call(a.Cb.files||[],function(h){U.createNode(b(h.name),d(h.name),U.Va,0,h,h.lastModifiedDate)});(a.Cb.blobs||[]).forEach(function(h){U.createNode(b(h.name),d(h.name),U.Va,0,h.data)});(a.Cb.packages||[]).forEach(function(h){h.metadata.files.forEach(function(k){var l=k.filename.substr(1);U.createNode(b(l),d(l),U.Va,0,h.blob.slice(k.start,k.end))})});return e},createNode:function(a,b,d,e,f,h){e=S.createNode(a,
...
},Ha:function(a,b,d){1===d?b+=a.position:2===d&&S.isFile(a.node.mode)&&(b+=a.node.size);if(0>b)throw new S.ra(28);return b}}},S={root:null,cb:[],Zb:{},streams:[],Rc:1,La:null,Yb:"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/",xb:!1,jc:!0,Da:{},oc:{mc:{tc:1,uc:2}},ra:null,ub:{},Gc:null,nb:0,Lc:function(a){if(!(a instanceof S.ra)){a:{var b=Error();if(!b.stack){try{throw Error();}catch(d){b=d}if(!b.stack){b="(no stack trace available)";break a}}b=b.stack.toString()}c.extraStackTrace&&(b+="\n"+c.extraStackTrace());b=Ta(b);throw a+" : "+b;}return Ya(a.wa)},
ya:function(a,b){a=R(S.cwd(),a);b=b||{};if(!a)return{path:"",node:null};var d={tb:!0,Gb:0},e;for(e in d)void 0===b[e]&&(b[e]=d[e]);if(8<b.Gb)throw new S.ra(32);a=Va(a.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/").filter(function(k){return!!k}),!1);var f=S.root;d="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/";for(e=0;e<a.length;e++){var h=e===a.length-1;if(h&&b.parent)break;f=S.Na(f,a[e]);d=Q(d,a[e]);S.Pa(f)&&(!h||h&&b.tb)&&(f=f.bb.root);if(!h||b.Fa)for(h=0;S.Sa(f.mode);)if(f=S.readlink(d),d=R(Wa(d),f),f=S.ya(d,{Gb:b.Gb}).node,40<h++)throw new S.ra(32);}return{path:d,node:f}},
Ja:function(a){for(var b;;){if(S.kb(a))return a=a.Aa.lc,b?"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"!==a[a.length-1]?a+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+b:a+b:a;b=b?a.name+"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+b:a.name;a=a.parent}},wb:function(a,b){for(var d=0,e=0;e<b.length;e++)d=(d<<5)-d+b.charCodeAt(e)|0;return(a+d>>>0)%S.La.length},hc:function(a){var b=S.wb(a.parent.id,a.name);a.Ra=S.La[b];S.La[b]=a},ic:function(a){var b=S.wb(a.parent.id,a.name);if(S.La[b]===a)S.La[b]=a.Ra;else for(b=S.La[b];b;){if(b.Ra===a){b.Ra=a.Ra;break}b=b.Ra}},Na:function(a,b){var d=S.Oc(a);if(d)throw new S.ra(d,a);for(d=
...
k.type.nc(k,a,e)})},Aa:function(a,b,d){var e="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===d,f=!d;if(e&&S.root)throw new S.ra(10);if(!e&&!f){var h=S.ya(d,{tb:!1});d=h.path;h=h.node;if(S.Pa(h))throw new S.ra(10);if(!S.Ba(h.mode))throw new S.ra(54);}b={type:a,Cb:b,lc:d,cb:[]};a=a.Aa(b);a.Aa=b;b.root=a;e?S.root=a:h&&(h.bb=b,h.Aa&&h.Aa.cb.push(b));return a},$c:function(a){a=S.ya(a,{tb:!1});if(!S.Pa(a.node))throw new S.ra(28);a=a.node;var b=a.bb,d=S.dc(b);Object.keys(S.La).forEach(function(e){for(e=S.La[e];e;){var f=e.Ra;-1!==d.indexOf(e.Aa)&&
S.sb(e);e=f}});a.bb=null;a.Aa.cb.splice(a.Aa.cb.indexOf(b),1)},lookup:function(a,b){return a.ta.lookup(a,b)},Ka:function(a,b,d){var e=S.ya(a,{parent:!0}).node;a=P(a);if(!a||"."===a||".."===a)throw new S.ra(28);var f=S.Bb(e,a);if(f)throw new S.ra(f);if(!e.ta.Ka)throw new S.ra(63);return e.ta.Ka(e,a,b,d)},create:function(a,b){return S.Ka(a,(void 0!==b?b:438)&4095|32768,0)},mkdir:function(a,b){return S.Ka(a,(void 0!==b?b:511)&1023|16384,0)},md:function(a,b){a=a.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");for(var d="",e=0;e<a.length;++e)if(a[e]){d+=
"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"+a[e];try{S.mkdir(d,b)}catch(f){if(20!=f.wa)throw f;}}},mb:function(a,b,d){"undefined"===typeof d&&(d=b,b=438);return S.Ka(a,b|8192,d)},symlink:function(a,b){if(!R(a))throw new S.ra(44);var d=S.ya(b,{parent:!0}).node;if(!d)throw new S.ra(44);b=P(b);var e=S.Bb(d,b);if(e)throw new S.ra(e);if(!d.ta.symlink)throw new S.ra(63);return d.ta.symlink(d,b,a)},rename:function(a,b){var d=Wa(a),e=Wa(b),f=P(a),h=P(b);try{var k=S.ya(a,{parent:!0});var l=k.node;k=S.ya(b,{parent:!0});var q=k.node}catch(t){throw new S.ra(10);
...
if(!S.Ba(a.node.mode))throw new S.ra(54);var b=S.Oa(a.node,"x");if(b)throw new S.ra(b);S.Yb=a.path},Bc:function(){S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/tmp");S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home");S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user")},Ac:function(){S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev");S.Hb(S.Qa(1,3),{read:function(){return 0},write:function(e,f,h,k){return k}});S.mb("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/null",S.Qa(1,3));bb(S.Qa(5,0),eb);bb(S.Qa(6,0),fb);S.mb("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/tty",S.Qa(5,0));S.mb("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/tty1",S.Qa(6,0));if("object"===typeof crypto&&"function"===typeof crypto.getRandomValues){var a=new Uint8Array(1);var b=
function(){crypto.getRandomValues(a);return a[0]}}else if(ea)try{var d=require("crypto");b=function(){return d.randomBytes(1)[0]}}catch(e){}b||(b=function(){u("random_device")});S.Ia("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev","random",b);S.Ia("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev","urandom",b);S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/shm");S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/shm/tmp")},Dc:function(){S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/proc");S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/proc/self");S.mkdir("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/proc/self/fd");S.Aa({Aa:function(){var a=S.createNode("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/proc/self","fd",16895,73);a.ta={lookup:function(b,d){var e=S.Ya(+d);if(!e)throw new S.ra(8);b={parent:null,Aa:{lc:"fake"},
ta:{readlink:function(){return e.path}}};return b.parent=b}};return a}},{},"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/proc/self/fd")},Ec:function(){c.stdin?S.Ia("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev","stdin",c.stdin):S.symlink("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/tty","https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stdin");c.stdout?S.Ia("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev","stdout",null,c.stdout):S.symlink("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/tty","https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stdout");c.stderr?S.Ia("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev","stderr",null,c.stderr):S.symlink("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/tty1","https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stderr");S.open("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stdin","r");S.open("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stdout","w");S.open("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/dev/stderr","w")},$b:function(){S.ra||(S.ra=function(a,b){this.node=b;this.Xc=function(d){this.wa=d};
this.Xc(a);this.message="FS error"},S.ra.prototype=Error(),S.ra.prototype.constructor=S.ra,[44].forEach(function(a){S.ub[a]=new S.ra(a);S.ub[a].stack="<generic error, no stack>"}))},Yc:function(){S.$b();S.La=Array(4096);S.Aa(T,{},"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/");S.Bc();S.Ac();S.Dc();S.Gc={MEMFS:T,WORKERFS:U}},Za:function(a,b,d){S.Za.xb=!0;S.$b();c.stdin=a||c.stdin;c.stdout=b||c.stdout;c.stderr=d||c.stderr;S.Ec()},quit:function(){S.Za.xb=!1;var a=c._fflush;a&&a(0);for(a=0;a<S.streams.length;a++){var b=S.streams[a];b&&S.close(b)}},
ib:function(a,b){var d=0;a&&(d|=365);b&&(d|=146);return d},jd:function(a,b){a=Xa.apply(null,a);b&&"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"==a[0]&&(a=a.substr(1));return a},bd:function(a,b){return R(b,a)},pd:function(a){return O(a)},ed:function(a,b){a=S.qb(a,b);if(a.exists)return a.object;Ya(a.error);return null},qb:function(a,b){try{var d=S.ya(a,{Fa:!b});a=d.path}catch(f){}var e={kb:!1,exists:!1,error:0,name:null,path:null,object:null,Tc:!1,Vc:null,Uc:null};try{d=S.ya(a,{parent:!0}),e.Tc=!0,e.Vc=d.path,e.Uc=d.node,e.name=P(a),d=S.ya(a,
{Fa:!b}),e.exists=!0,e.path=d.path,e.object=d.node,e.name=d.node.name,e.kb="https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/"===d.path}catch(f){e.error=f.wa}return e},Tb:function(a,b,d,e){a=Q("string"===typeof a?a:S.Ja(a),b);return S.mkdir(a,S.ib(d,e))},Wb:function(a,b){a="string"===typeof a?a:S.Ja(a);for(b=b.split("https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/").reverse();b.length;){var d=b.pop();if(d){var e=Q(a,d);try{S.mkdir(e)}catch(f){}a=e}}return e},Cc:function(a,b,d,e,f){a=Q("string"===typeof a?a:S.Ja(a),b);return S.create(a,S.ib(e,f))},hb:function(a,b,d,e,f,h){a=b?Q("string"===
...
function mb(){if(!nb){var a={USER:"web_user",LOGNAME:"web_user",PATH:"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/",PWD:"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/",HOME:"https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/home/web_user",LANG:("object"===typeof navigator&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:ca||"./this.program"},b;for(b in lb)a[b]=lb[b];var d=[];for(b in a)d.push(b+"="+a[b]);nb=d}return nb}var nb;ra("GMT",67200,4);
...
var readRARContentWorkerFS = function (data, password,callbackFn) {
  ...
  if(!start) Module.FS.mkdir('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/x')
  Module.FS.mount(Module.WORKERFS, {
    ...
    canOwn: true,
    flags: 'w+'
  }, 'https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/x')
  if(!start) Module.FS.chdir('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/x');
  start = true;
  ...
  while (res === ERAR_SUCCESS) { i++
    ...
    if (PFCode === ERAR_SUCCESS) {
      returnVal.push({
        ...
        fileNameSplit: pars.currFileName.split('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/'),
...
function cleanup (data,handle,cb,type) {
  ...
  if(type=='W') Module.FS.unmount('https://cdn.jsdelivr.net/gh/muffinisgoated/jsdelivrrr@main/x')
